...
<keywordspec name="RPA.Outlook.Application" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:51Z" specversion="3" source="./RPA/Outlook/Application.py" lineno="44">
<version/>
...
<inits>
<init name="Init" source="./RPA/Outlook/Application.py" lineno="105">
...
<keywords>
<kw name="Close Document" source="./RPA/Outlook/Application.py" lineno="134">
...
<kw name="Get Emails" source="./RPA/Outlook/Application.py" lineno="336">
...
<kw name="Mark Email As Read" source="./RPA/Outlook/Application.py" lineno="483">
...
<kw name="Move Emails" source="./RPA/Outlook/Application.py" lineno="512">
...
<kw name="Open Application" source="./RPA/Outlook/Application.py" lineno="116">
...
<kw name="Quit Application" source="./RPA/Outlook/Application.py" lineno="144">
<arguments repr="save_changes: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="save_changes: bool = False">
<name>save_changes</name>
<type>bool</type>
...
<kw name="Save Email Attachments" source="./RPA/Outlook/Application.py" lineno="444">
<arguments repr="attachments: Any, attachment_folder: str">
...
<kw name="Send Email" source="./RPA/Outlook/Application.py" lineno="179">
<arguments repr="recipients: Any, subject: str, body: str, html_body: bool = False, attachments: Any | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="recipients: Any">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="attachments: Any | None = None">
<name>attachments</name>
<type>Any</type>
<type>None</type>
<default>None</default>
...
<kw name="Send Message" source="./RPA/Outlook/Application.py" lineno="155">
<arguments repr="recipients: Any, subject: str, body: str, html_body: bool = False, attachments: Any | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="recipients: Any">
<name>recipients</name>
<type>Any</type>
...
<kw name="Wait For Email" source="./RPA/Outlook/Application.py" lineno="292">
...
<kw name="Wait For Message" source="./RPA/Outlook/Application.py" lineno="267">
<arguments repr="criterion: str | None = None, timeout: float = 5.0, interval: float = 1.0">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="criterion: str | None = None">
<name>criterion</name>
<type>str</type>
