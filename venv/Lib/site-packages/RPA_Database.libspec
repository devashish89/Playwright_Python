...
<keywordspec name="RPA.Database" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:47Z" specversion="3" source="./RPA/Database.py" lineno="112">
<version/>
...
<keywords>
<kw name="Call Stored Procedure" source="./RPA/Database.py" lineno="346">
<arguments repr="name, params=None, sanstran=False">
...
<kw name="Connect To Database" source="./RPA/Database.py" lineno="177">
<arguments repr="module_name: str | None = None, database: str | None = None, username: str | None = None, password: str | None = None, host: str | None = None, port: int | None = None, charset: str | None = None, config_file: str = db.cfg, autocommit: bool = False">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="config_file: str = db.cfg">
<name>config_file</name>
<type>str</type>
<default>db.cfg</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="autocommit: bool = False">
...
.. code-block:: robotframework
    ...
    Connect To Database  ${CURDIR}${/}resources${/}dbconfig.cfg</doc>
<shortdoc>Connect to database using DB API 2.0 module.</shortdoc>
</kw>
<kw name="Description" source="./RPA/Database.py" lineno="388">
<arguments repr="table">
...
<kw name="Disconnect From Database" source="./RPA/Database.py" lineno="410">
<arguments repr="">
</arguments>
...
<kw name="Execute Sql Script" source="./RPA/Database.py" lineno="426">
<arguments repr="filename, sanstran=False, encoding=utf-8">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="filename">
<name>filename</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="sanstran=False">
<name>sanstran</name>
...
<kw name="Get Number Of Rows" source="./RPA/Database.py" lineno="645">
<arguments repr="table, conditions=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="table">
<name>table</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="conditions=None">
...
<kw name="Get Rows" source="./RPA/Database.py" lineno="618">
<arguments repr="table, columns=None, conditions=None, as_table=True">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="table">
<name>table</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="columns=None">
<name>columns</name>
<default>None</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="conditions=None">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="as_table=True">
<name>as_table</name>
...
<kw name="Query" source="./RPA/Database.py" lineno="481">
<arguments repr="statement: str, assertion: str | None = None, sanstran: bool = False, as_table: bool = True, returning: bool | None = None">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="sanstran: bool = False">
<name>sanstran</name>
<type>bool</type>
<default>False</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="as_table: bool = True">
<name>as_table</name>
<type>bool</type>
<default>True</default>
</arg>
...
<kw name="Set Auto Commit" source="./RPA/Database.py" lineno="603">
