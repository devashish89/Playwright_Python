...
<keywordspec name="RPA.RobotLogListener" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:51Z" specversion="3" source="./RPA/core/logger.py" lineno="24">
<version/>
...
<keywords>
<kw name="End Keyword" source="./RPA/core/logger.py" lineno="266">
...
<kw name="Mute Run On Failure" source="./RPA/core/logger.py" lineno="184">
...
<kw name="Only Info Level" source="./RPA/core/logger.py" lineno="156">
...
<kw name="Register Protected Keywords" source="./RPA/core/logger.py" lineno="170">
<arguments repr="names: str | List | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="names: str | List | None = None">
<name>names</name>
<type>str</type>
...
<kw name="Start Keyword" source="./RPA/core/logger.py" lineno="226">
<arguments repr="name, attributes">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="name">
<name>name</name>
</arg>
