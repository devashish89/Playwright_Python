...
<keywordspec name="RPA.Excel.Files" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:49Z" specversion="3" source="./RPA/Excel/Files.py" lineno="61">
<version/>
...
<keywords>
<kw name="Append Rows To Worksheet" source="./RPA/Excel/Files.py" lineno="397">
...
.. code-block:: robotframework
    ...
    Append rows to worksheet    ${table}    header=${TRUE}   start=5</doc>
<shortdoc>Append values to the end of the worksheet.</shortdoc>
</kw>
<kw name="Close Workbook" source="./RPA/Excel/Files.py" lineno="260">
<arguments repr="">
</arguments>
<doc>Close the active workbook.</doc>
<shortdoc>Close the active workbook.</shortdoc>
</kw>
<kw name="Create Workbook" source="./RPA/Excel/Files.py" lineno="201">
...
.. code-block:: robotframework
    ...
    Save workbook    orders.xls</doc>
<shortdoc>Create and open a new Excel workbook.</shortdoc>
</kw>
<kw name="Create Worksheet" source="./RPA/Excel/Files.py" lineno="331">
...
.. code-block:: robotframework
    ...
    Open workbook       customers.xlsx
    Create worksheet    Orders</doc>
<shortdoc>Create a new worksheet in the current workbook.</shortdoc>
</kw>
<kw name="Find Empty Row" source="./RPA/Excel/Files.py" lineno="464">
...
.. code-block:: robotframework
    ...
    Append rows to worksheet     ${rows}
    ${next}=    Find empty row
    Insert image to worksheet    ${next}    A    screenshot.png</doc>
<shortdoc>Find the first empty row after existing content, and return the row number.</shortdoc>
</kw>
<kw name="Get Active Worksheet" source="./RPA/Excel/Files.py" lineno="306">
<arguments repr="">
</arguments>
...
<kw name="Get Cell Value" source="./RPA/Excel/Files.py" lineno="481">
...
.. code-block:: robotframework
    ...
    ${column3}=    Get cell value    1    C</doc>
<shortdoc>Get a cell value in the given worksheet.</shortdoc>
</kw>
<kw name="Get Worksheet Value" source="./RPA/Excel/Files.py" lineno="598">
<arguments repr="row, column, name=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="row">
<name>row</name>
</arg>
...
<kw name="Insert Image To Worksheet" source="./RPA/Excel/Files.py" lineno="560">
...
.. code-block:: robotframework
    ...
    Insert image to worksheet    ${last_row}    A    screenshot.png</doc>
<shortdoc>Insert an image into the given cell.</shortdoc>
</kw>
<kw name="List Worksheets" source="./RPA/Excel/Files.py" lineno="296">
<arguments repr="">
</arguments>
...
<kw name="Open Workbook" source="./RPA/Excel/Files.py" lineno="235">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
.. code-block:: robotframework
    ...
    ${table}=    Read worksheet as table</doc>
<shortdoc>Open an existing Excel workbook.</shortdoc>
</kw>
<kw name="Read Worksheet" source="./RPA/Excel/Files.py" lineno="354">
...
<kw name="Read Worksheet As Table" source="./RPA/Excel/Files.py" lineno="375">
...
.. code-block:: robotframework
    ...
    Close Workbook</doc>
<shortdoc>Read the content of a worksheet into a Table container. Allows sorting/filtering/manipulating using the ``RPA.Tables`` library.</shortdoc>
</kw>
<kw name="Remove Worksheet" source="./RPA/Excel/Files.py" lineno="431">
<arguments repr="name=None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="name=None">
<name>name</name>
<default>None</default>
...
.. code-block:: robotframework
    ...
    Open workbook    orders.xlsx
    ${sheets}=       List worksheets
    Remove worksheet    ${sheets}[-1]</doc>
<shortdoc>Remove a worksheet from the active workbook.</shortdoc>
</kw>
<kw name="Rename Worksheet" source="./RPA/Excel/Files.py" lineno="448">
...
.. code-block:: robotframework
    ...
    Create workbook
    Rename worksheet    Sheet    Orders</doc>
<shortdoc>Rename an existing worksheet in the active workbook.</shortdoc>
</kw>
<kw name="Save Workbook" source="./RPA/Excel/Files.py" lineno="267">
...
<kw name="Set Active Worksheet" source="./RPA/Excel/Files.py" lineno="311">
...
.. code-block:: robotframework
    ...
    Append rows to worksheet    ${rows}</doc>
<shortdoc>Set the active worksheet.</shortdoc>
</kw>
<kw name="Set Cell Format" source="./RPA/Excel/Files.py" lineno="527">
...
<doc>Set number format for cell.
...
.. code-block:: robotframework
    ...
    Set cell format   2  B    00.0</doc>
<shortdoc>Set number format for cell.</shortdoc>
</kw>
<kw name="Set Cell Value" source="./RPA/Excel/Files.py" lineno="500">
...
.. code-block:: robotframework
    ...
    Set cell value    2    B    ${value}    fmt=0%</doc>
<shortdoc>Set a cell value in the given worksheet.</shortdoc>
</kw>
<kw name="Set Worksheet Value" source="./RPA/Excel/Files.py" lineno="604">
<arguments repr="row, column, value, name=None, fmt=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="row">
<name>row</name>
</arg>
...
<kw name="Worksheet Exists" source="./RPA/Excel/Files.py" lineno="301">
<arguments repr="name">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="name">
<name>name</name>
</arg>
