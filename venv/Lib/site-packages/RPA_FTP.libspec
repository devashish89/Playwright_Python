...
<keywordspec name="RPA.FTP" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:49Z" specversion="3" source="./RPA/FTP.py" lineno="39">
<version/>
...
<keywords>
<kw name="Abort" source="./RPA/FTP.py" lineno="276">
<arguments repr="">
</arguments>
<doc>Abort a file transfer in progress</doc>
<shortdoc>Abort a file transfer in progress</shortdoc>
</kw>
<kw name="Close" source="./RPA/FTP.py" lineno="154">
<arguments repr="">
</arguments>
...
:raises AuthenticationException: on authentication error with the server</doc>
<shortdoc>Connect to FTP server</shortdoc>
</kw>
<kw name="Cwd" source="./RPA/FTP.py" lineno="199">
...
:param dirname: name of the directory</doc>
<shortdoc>Change working directory on the server</shortdoc>
</kw>
<kw name="Delete" source="./RPA/FTP.py" lineno="239">
...
:param filepath: path to server file</doc>
<shortdoc>Delete file on the server</shortdoc>
</kw>
<kw name="Download" source="./RPA/FTP.py" lineno="171">
...
:param localfile: name of the downloaded file on the local filesystem,
    if `None` will have same name as remote file</doc>
<shortdoc>Download file from FTP server</shortdoc>
</kw>
<kw name="File Size" source="./RPA/FTP.py" lineno="267">
<arguments repr="filepath: str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="filepath: str">
<name>filepath</name>
<type>str</type>
...
<kw name="Get Welcome Message" source="./RPA/FTP.py" lineno="281">
<arguments repr="">
</arguments>
<doc>Get server welcome message

:return: welcome message</doc>
<shortdoc>Get server welcome message</shortdoc>
</kw>
<kw name="List Files" source="./RPA/FTP.py" lineno="228">
<arguments repr="dirname: str = ">
...
<kw name="Mkd" source="./RPA/FTP.py" lineno="212">
<arguments repr="dirname: str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="dirname: str">
<name>dirname</name>
<type>str</type>
...
<kw name="Pwd" source="./RPA/FTP.py" lineno="207">
<arguments repr="">
</arguments>
<doc>Get current working directory on the server</doc>
<shortdoc>Get current working directory on the server</shortdoc>
</kw>
<kw name="Quit" source="./RPA/FTP.py" lineno="144">
<arguments repr="">
</arguments>
...
<kw name="Rename" source="./RPA/FTP.py" lineno="247">
...
:param toname: new name for the file</doc>
<shortdoc>Rename file on the server</shortdoc>
</kw>
<kw name="Rmd" source="./RPA/FTP.py" lineno="220">
<arguments repr="dirname: str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="dirname: str">
<name>dirname</name>
<type>str</type>
...
<kw name="Send Command" source="./RPA/FTP.py" lineno="256">
...
:param command: name of the command to send</doc>
<shortdoc>Execute command on the server</shortdoc>
</kw>
<kw name="Set Ascii Mode" source="./RPA/FTP.py" lineno="303">
<arguments repr="">
</arguments>
<doc>Set transfer mode to ASCII</doc>
<shortdoc>Set transfer mode to ASCII</shortdoc>
</kw>
<kw name="Set Binary Mode" source="./RPA/FTP.py" lineno="307">
<arguments repr="">
</arguments>
<doc>Set transfer mode to BINARY</doc>
<shortdoc>Set transfer mode to BINARY</shortdoc>
</kw>
<kw name="Set Debug Level" source="./RPA/FTP.py" lineno="289">
...
<kw name="Upload" source="./RPA/FTP.py" lineno="161">
...
:param remotefile: name of uploaded file in the server</doc>
