...
<keywordspec name="RPA.Archive" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:46Z" specversion="3" source="./RPA/Archive.py" lineno="45">
<version/>
...
<keywords>
<kw name="Add To Archive" source="./RPA/Archive.py" lineno="191">
...
<kw name="Archive Folder With Tar" source="./RPA/Archive.py" lineno="150">
...
<kw name="Archive Folder With Zip" source="./RPA/Archive.py" lineno="83">
...
<kw name="Extract Archive" source="./RPA/Archive.py" lineno="333">
...
<kw name="Extract File From Archive" source="./RPA/Archive.py" lineno="374">
...
<kw name="Get Archive Info" source="./RPA/Archive.py" lineno="291">
...
<kw name="List Archive" source="./RPA/Archive.py" lineno="239">
<arguments repr="archive_name: str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="archive_name: str">
<name>archive_name</name>
<type>str</type>
