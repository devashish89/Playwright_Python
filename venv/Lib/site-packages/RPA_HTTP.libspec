...
<keywordspec name="RPA.HTTP" type="LIBRARY" format="ROBOT" scope="GLOBAL" generated="2022-01-12T14:02:49Z" specversion="3" source="./RPA/HTTP.py" lineno="11">
<version>0.9.2</version>
<doc>RPA Framework HTTP library that extends functionality of RequestsLibrary,
for more information see: https://github.com/MarketSquare/robotframework-requests</doc>
<tags>
</tags>
<inits>
<init name="Init" source="./RPA/HTTP.py" lineno="19">
...
<arguments repr="alias, url, headers={}, cookies={}, client_certs=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['GET', 'PUT', 'DELETE', 'TRACE', 'OPTIONS', 'HEAD']">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="retry_method_list=['GET', 'PUT', 'DELETE', 'TRACE', 'OPTIONS', 'HEAD']">
<name>retry_method_list</name>
<default>['GET', 'PUT', 'DELETE', 'TRACE', 'OPTIONS', 'HEAD']</default>
</arg>
</arguments>
...
<arguments repr="alias, url, auth, headers={}, cookies={}, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['GET', 'PUT', 'DELETE', 'TRACE', 'OPTIONS', 'HEAD']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
...
<arguments repr="alias, url, headers={}, cookies={}, auth=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['GET', 'PUT', 'DELETE', 'TRACE', 'OPTIONS', 'HEAD']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
...
<kw name="Download" source="./RPA/HTTP.py" lineno="104">
...
``stream`` if ``False``, the response content will be immediately downloaded</doc>
...
<kw name="Get Current Session Alias" source="./RPA/HTTP.py" lineno="97">
<arguments repr="">
</arguments>
<doc>Get request session alias that was used with the ``HTTP Get`` keyword.

Return name of session alias.</doc>
...
<kw name="Http Get" source="./RPA/HTTP.py" lineno="26">
<arguments repr="url: str, target_file: str | None = None, verify: bool | str = True, force_new_session: bool = False, overwrite: bool = False, stream: bool = False, **kwargs">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url: str">
<name>url</name>
<type>str</type>
