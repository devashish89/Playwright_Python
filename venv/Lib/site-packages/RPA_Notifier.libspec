...
<keywordspec name="RPA.Notifier" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:51Z" specversion="3" source="./RPA/Notifier.py" lineno="5">
<version/>
...
<keywords>
<kw name="Generic Notify" source="./RPA/Notifier.py" lineno="314">
...
<kw name="Notify Email" source="./RPA/Notifier.py" lineno="233">
...
<kw name="Notify Gmail" source="./RPA/Notifier.py" lineno="205">
...
<kw name="Notify Pushover" source="./RPA/Notifier.py" lineno="134">
...
<kw name="Notify Slack" source="./RPA/Notifier.py" lineno="155">
...
<kw name="Notify Telegram" source="./RPA/Notifier.py" lineno="180">
...
<kw name="Notify Twilio" source="./RPA/Notifier.py" lineno="283">
