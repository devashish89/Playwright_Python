...
<keywordspec name="RPA.Images" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:49Z" specversion="3" source="./RPA/Images.py" lineno="68">
<version/>
...
<keywords>
<kw name="Crop Image" source="./RPA/Images.py" lineno="145">
...
<kw name="Find Template In Image" source="./RPA/Images.py" lineno="163">
...
<kw name="Get Pixel Color In Image" source="./RPA/Images.py" lineno="225">
...
<kw name="Show Region In Image" source="./RPA/Images.py" lineno="210">
