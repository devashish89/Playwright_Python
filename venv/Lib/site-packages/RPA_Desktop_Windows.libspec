...
<keywordspec name="RPA.Desktop.Windows" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:48Z" specversion="3" source="./RPA/Desktop/Windows.py" lineno="104">
<version/>
...
<inits>
<init name="Init" source="./RPA/Desktop/Windows.py" lineno="207">
...
<kw name="Calculate Rectangle Center" source="./RPA/Desktop/Windows.py" lineno="1928">
...
<kw name="Click Type" source="./RPA/Desktop/Windows.py" lineno="1462">
...
<kw name="Close All Applications" source="./RPA/Desktop/Windows.py" lineno="799">
<arguments repr="">
</arguments>
...
<kw name="Connect By Handle" source="./RPA/Desktop/Windows.py" lineno="754">
...
<kw name="Connect By Pid" source="./RPA/Desktop/Windows.py" lineno="730">
...
<kw name="Drag And Drop" source="./RPA/Desktop/Windows.py" lineno="1835">
...
<kw name="Find Element" source="./RPA/Desktop/Windows.py" lineno="1296">
...
<kw name="Get App" source="./RPA/Desktop/Windows.py" lineno="324">
...
<kw name="Get Dialog Rectangle" source="./RPA/Desktop/Windows.py" lineno="1412">
...
<kw name="Get Element" source="./RPA/Desktop/Windows.py" lineno="1084">
...
<kw name="Get Element Center" source="./RPA/Desktop/Windows.py" lineno="1446">
...
<kw name="Get Element Rectangle" source="./RPA/Desktop/Windows.py" lineno="1157">
...
<kw name="Get Element Rich Text" source="./RPA/Desktop/Windows.py" lineno="1132">
...
<kw name="Get Open Applications" source="./RPA/Desktop/Windows.py" lineno="307">
<arguments repr="">
</arguments>
...
<kw name="Get Spaced String" source="./RPA/Desktop/Windows.py" lineno="542">
<arguments repr="text">
...
<kw name="Get Text" source="./RPA/Desktop/Windows.py" lineno="914">
<arguments repr="locator: str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str">
<name>locator</name>
<type>str</type>
...
<kw name="Get Window Elements" source="./RPA/Desktop/Windows.py" lineno="1493">
...
<kw name="Get Window List" source="./RPA/Desktop/Windows.py" lineno="1947">
<arguments repr="">
</arguments>
...
<kw name="Is Element Enabled" source="./RPA/Desktop/Windows.py" lineno="1209">
<arguments repr="locator: str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str">
<name>locator</name>
<type>str</type>
...
<kw name="Is Element Matching" source="./RPA/Desktop/Windows.py" lineno="1398">
...
<kw name="Is Element Visible" source="./RPA/Desktop/Windows.py" lineno="1193">
<arguments repr="locator: str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str">
<name>locator</name>
<type>str</type>
...
<kw name="Lock Screen" source="./RPA/Desktop/Windows.py" lineno="1743">
<arguments repr="">
</arguments>
...
<kw name="Log In" source="./RPA/Desktop/Windows.py" lineno="1754">
...
<kw name="Menu Select" source="./RPA/Desktop/Windows.py" lineno="1225">
...
<kw name="Minimize Dialog" source="./RPA/Desktop/Windows.py" lineno="596">
...
<kw name="Mouse Click" source="./RPA/Desktop/Windows.py" lineno="951">
...
<kw name="Mouse Click Coords" source="./RPA/Desktop/Windows.py" lineno="1061">
...
<kw name="Mouse Click Image" source="./RPA/Desktop/Windows.py" lineno="1029">
...
<kw name="Open Application" source="./RPA/Desktop/Windows.py" lineno="345">
...
<kw name="Open Dialog" source="./RPA/Desktop/Windows.py" lineno="672">
...
<kw name="Open Executable" source="./RPA/Desktop/Windows.py" lineno="418">
...
<kw name="Open File" source="./RPA/Desktop/Windows.py" lineno="374">
...
<kw name="Open From Search" source="./RPA/Desktop/Windows.py" lineno="492">
...
<kw name="Open Using Run Dialog" source="./RPA/Desktop/Windows.py" lineno="458">
<arguments repr="executable: str, windowtitle: str, timeout: int = 10, wildcard: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="executable: str">
<name>executable</name>
<type>str</type>
...
<kw name="Put System To Sleep" source="./RPA/Desktop/Windows.py" lineno="1721">
<arguments repr="">
</arguments>
...
<kw name="Quit Application" source="./RPA/Desktop/Windows.py" lineno="818">
<arguments repr="app_id: str | None = None, send_keys: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="app_id: str | None = None">
<name>app_id</name>
<type>str</type>
<type>None</type>
<default>None</default>
...
<kw name="Refresh Window" source="./RPA/Desktop/Windows.py" lineno="1994">
<arguments repr="">
</arguments>
...
<kw name="Restore Dialog" source="./RPA/Desktop/Windows.py" lineno="619">
<arguments repr="windowtitle: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="windowtitle: str | None = None">
<name>windowtitle</name>
<type>str</type>
...
<kw name="Screenshot" source="./RPA/Desktop/Windows.py" lineno="1599">
...
<kw name="Send Keys" source="./RPA/Desktop/Windows.py" lineno="899">
...
<kw name="Send Keys To Input" source="./RPA/Desktop/Windows.py" lineno="559">
...
<kw name="Set Automation Speed" source="./RPA/Desktop/Windows.py" lineno="2034">
...
<kw name="Set Windows Backend" source="./RPA/Desktop/Windows.py" lineno="221">
...
<kw name="Switch To Application" source="./RPA/Desktop/Windows.py" lineno="281">
...
<kw name="Type Into" source="./RPA/Desktop/Windows.py" lineno="875">
...
<kw name="Type Keys" source="./RPA/Desktop/Windows.py" lineno="858">
<arguments repr="keys: str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="keys: str">
<name>keys</name>
<type>str</type>
...
<kw name="Wait For Element" source="./RPA/Desktop/Windows.py" lineno="1248">
<arguments repr="locator: str, search_criteria: str | None = None, timeout: float = 30.0, interval: float = 2.0">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str">
<name>locator</name>
<type>str</type>
</arg>
