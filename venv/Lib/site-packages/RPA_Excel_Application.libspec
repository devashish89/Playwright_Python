...
<keywordspec name="RPA.Excel.Application" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:49Z" specversion="3" source="./RPA/Excel/Application.py" lineno="43">
<version/>
...
<inits>
<init name="Init" source="./RPA/Excel/Application.py" lineno="93">
...
<keywords>
<kw name="Add New Sheet" source="./RPA/Excel/Application.py" lineno="196">
...
<kw name="Add New Workbook" source="./RPA/Excel/Application.py" lineno="147">
<arguments repr="">
</arguments>
<doc>Adds new workbook for Excel application</doc>
<shortdoc>Adds new workbook for Excel application</shortdoc>
</kw>
<kw name="Close Document" source="./RPA/Excel/Application.py" lineno="125">
...
<kw name="Export As Pdf" source="./RPA/Excel/Application.py" lineno="394">
...
<kw name="Find First Available Cell" source="./RPA/Excel/Application.py" lineno="241">
...
<kw name="Find First Available Row" source="./RPA/Excel/Application.py" lineno="226">
<arguments repr="worksheet: Any | None = None, row: int = 1, column: int = 1">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="worksheet: Any | None = None">
<name>worksheet</name>
<type>Any</type>
...
<kw name="Open Application" source="./RPA/Excel/Application.py" lineno="106">
...
<kw name="Open Workbook" source="./RPA/Excel/Application.py" lineno="155">
...
<kw name="Quit Application" source="./RPA/Excel/Application.py" lineno="136">
<arguments repr="save_changes: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="save_changes: bool = False">
<name>save_changes</name>
<type>bool</type>
...
<kw name="Read From Cells" source="./RPA/Excel/Application.py" lineno="303">
...
<kw name="Run Macro" source="./RPA/Excel/Application.py" lineno="379">
...
<kw name="Save Excel" source="./RPA/Excel/Application.py" lineno="329">
<arguments repr="">
</arguments>
<doc>Saves Excel file</doc>
<shortdoc>Saves Excel file</shortdoc>
</kw>
<kw name="Save Excel As" source="./RPA/Excel/Application.py" lineno="337">
...
<kw name="Set Active Worksheet" source="./RPA/Excel/Application.py" lineno="179">
...
<kw name="Write To Cells" source="./RPA/Excel/Application.py" lineno="265">
