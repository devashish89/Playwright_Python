...
<keywordspec name="RPA.SAP" type="LIBRARY" format="ROBOT" scope="GLOBAL" generated="2022-01-12T14:02:51Z" specversion="3" source="./RPA/SAP.py" lineno="17">
<version>1.1</version>
...
<inits>
<init name="Init" source="./RPA/SAP.py" lineno="26">
...
<kw name="Get Cell Value" source="./SapGuiLibrary/SapGuiLibrary.py" lineno="275">
