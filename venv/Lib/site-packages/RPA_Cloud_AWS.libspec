...
<keywordspec name="RPA.Cloud.AWS" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:47Z" specversion="3" source="./RPA/Cloud/AWS.py" lineno="891">
<version/>
...
<inits>
<init name="Init" source="./RPA/Cloud/AWS.py" lineno="999">
...
<keywords>
<kw name="Analyze Document" source="./RPA/Cloud/AWS.py" lineno="361">
...
<kw name="Convert Textract Response To Model" source="./RPA/Cloud/AWS.py" lineno="691">
...
<kw name="Create Bucket" source="./RPA/Cloud/AWS.py" lineno="144">
...
<kw name="Create Queue" source="./RPA/Cloud/AWS.py" lineno="867">
...
<kw name="Delete Bucket" source="./RPA/Cloud/AWS.py" lineno="160">
<arguments repr="bucket_name: str = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="bucket_name: str = None">
<name>bucket_name</name>
<type>str</type>
...
<kw name="Delete Files" source="./RPA/Cloud/AWS.py" lineno="186">
...
<kw name="Delete Message" source="./RPA/Cloud/AWS.py" lineno="853">
...
<kw name="Delete Queue" source="./RPA/Cloud/AWS.py" lineno="879">
<arguments repr="queue_name: str = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="queue_name: str = None">
<name>queue_name</name>
<type>str</type>
...
<kw name="Detect Document Text" source="./RPA/Cloud/AWS.py" lineno="490">
...
<kw name="Detect Entities" source="./RPA/Cloud/AWS.py" lineno="778">
...
<kw name="Detect Sentiment" source="./RPA/Cloud/AWS.py" lineno="760">
<arguments repr="text: str = None, lang=en">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="text: str = None">
<name>text</name>
<type>str</type>
...
<kw name="Download Files" source="./RPA/Cloud/AWS.py" lineno="305">
...
<kw name="Get Cells" source="./RPA/Cloud/AWS.py" lineno="482">
<arguments repr="">
</arguments>
...
<kw name="Get Document Analysis" source="./RPA/Cloud/AWS.py" lineno="563">
<arguments repr="job_id: str = None, max_results: int = 1000, next_token: str = None">
...
<kw name="Get Document Text Detection" source="./RPA/Cloud/AWS.py" lineno="657">
<arguments repr="job_id: str = None, max_results: int = 1000, next_token: str = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="job_id: str = None">
<name>job_id</name>
<type>str</type>
...
<kw name="Get Pages And Text" source="./RPA/Cloud/AWS.py" lineno="597">
...
<kw name="Get Tables" source="./RPA/Cloud/AWS.py" lineno="468">
<arguments repr="">
</arguments>
...
<kw name="Get Words" source="./RPA/Cloud/AWS.py" lineno="475">
<arguments repr="">
</arguments>
...
<kw name="Init Comprehend Client" source="./RPA/Cloud/AWS.py" lineno="741">
...
<kw name="Init S3 Client" source="./RPA/Cloud/AWS.py" lineno="127">
<arguments repr="aws_key_id: str | None = None, aws_key: str | None = None, region: str | None = None, use_robocloud_vault: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="aws_key_id: str | None = None">
<name>aws_key_id</name>
<type>str</type>
...
<kw name="Init Sqs Client" source="./RPA/Cloud/AWS.py" lineno="799">
...
<kw name="Init Textract Client" source="./RPA/Cloud/AWS.py" lineno="344">
<arguments repr="aws_key_id: str | None = None, aws_key: str | None = None, region: str | None = None, use_robocloud_vault: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="aws_key_id: str | None = None">
<name>aws_key_id</name>
<type>str</type>
...
<kw name="List Buckets" source="./RPA/Cloud/AWS.py" lineno="176">
<arguments repr="">
</arguments>
...
<kw name="List Files" source="./RPA/Cloud/AWS.py" lineno="211">
...
<kw name="Receive Message" source="./RPA/Cloud/AWS.py" lineno="841">
<arguments repr="">
</arguments>
...
<kw name="Send Message" source="./RPA/Cloud/AWS.py" lineno="819">
...
<kw name="Set Robocloud Vault" source="./RPA/Cloud/AWS.py" lineno="111">
...
<kw name="Start Document Analysis" source="./RPA/Cloud/AWS.py" lineno="517">
...
<kw name="Start Document Text Detection" source="./RPA/Cloud/AWS.py" lineno="614">
<arguments repr="bucket_name_in: str = None, object_name_in: str = None, object_version_in: str = None, bucket_name_out: str = None, prefix_object_out: str = textract_output">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="bucket_name_in: str = None">
<name>bucket_name_in</name>
<type>str</type>
...
<kw name="Upload File" source="./RPA/Cloud/AWS.py" lineno="247">
...
<kw name="Upload Files" source="./RPA/Cloud/AWS.py" lineno="266">
<arguments repr="bucket_name: str = None, files: list = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="bucket_name: str = None">
<name>bucket_name</name>
<type>str</type>
