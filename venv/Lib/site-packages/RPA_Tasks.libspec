...
<keywordspec name="RPA.Tasks" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:51Z" specversion="3" source="./RPA/Tasks.py" lineno="332">
<version/>
...
<inits>
<init name="Init" source="./RPA/Tasks.py" lineno="621">
...
<keywords>
<kw name="Jump To Task" source="./RPA/Tasks.py" lineno="824">
<arguments repr="name">
...
<kw name="Jump To Task If" source="./RPA/Tasks.py" lineno="832">
...
<kw name="Jump To Task If Keyword Fails" source="./RPA/Tasks.py" lineno="850">
...
<kw name="Jump To Task If Keyword Succeeds" source="./RPA/Tasks.py" lineno="856">
<arguments repr="task, keyword, *args">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="task">
<name>task</name>
</arg>
...
<kw name="Set Next Task" source="./RPA/Tasks.py" lineno="783">
<arguments repr="name">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="name">
<name>name</name>
</arg>
...
<kw name="Set Next Task If" source="./RPA/Tasks.py" lineno="804">
<arguments repr="condition, name, default=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="condition">
<name>condition</name>
</arg>
...
<kw name="Set Next Task If Keyword Fails" source="./RPA/Tasks.py" lineno="838">
<arguments repr="task, keyword, *args">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="task">
<name>task</name>
</arg>
...
<kw name="Set Next Task If Keyword Succeeds" source="./RPA/Tasks.py" lineno="844">
<arguments repr="task, keyword, *args">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="task">
<name>task</name>
</arg>
