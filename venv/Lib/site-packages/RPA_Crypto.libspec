...
<keywordspec name="RPA.Crypto" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:47Z" specversion="3" source="./RPA/Crypto.py" lineno="43">
<version/>
...
<keywords>
<kw name="Decrypt File" source="./RPA/Crypto.py" lineno="296">
<arguments repr="path: str, output: str | None = None">
...
<kw name="Decrypt String" source="./RPA/Crypto.py" lineno="225">
<arguments repr="data: bytes | str, encoding=utf-8">
...
<kw name="Encrypt File" source="./RPA/Crypto.py" lineno="262">
<arguments repr="path: str, output: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path: str">
<name>path</name>
<type>str</type>
...
<kw name="Encrypt String" source="./RPA/Crypto.py" lineno="203">
<arguments repr="text: bytes | str, encoding=utf-8">
...
<kw name="Generate Key" source="./RPA/Crypto.py" lineno="95">
<arguments repr="">
</arguments>
...
<kw name="Hash File" source="./RPA/Crypto.py" lineno="179">
...
<kw name="Hash String" source="./RPA/Crypto.py" lineno="156">
...
<kw name="Use Encryption Key" source="./RPA/Crypto.py" lineno="107">
<arguments repr="key: str">
...
<kw name="Use Encryption Key From Vault" source="./RPA/Crypto.py" lineno="125">
<arguments repr="name: str, key: str | None = None">
