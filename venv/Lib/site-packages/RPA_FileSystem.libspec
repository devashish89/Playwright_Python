...
<keywordspec name="RPA.FileSystem" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:49Z" specversion="3" source="./RPA/FileSystem.py" lineno="70">
<version/>
...
<keywords>
<kw name="Absolute Path" source="./RPA/FileSystem.py" lineno="512">
<arguments repr="path">
...
:return:        absolute path to file</doc>
<shortdoc>Returns the absolute path to a file, and resolves symlinks.</shortdoc>
</kw>
<kw name="Append To Binary File" source="./RPA/FileSystem.py" lineno="330">
...
<kw name="Append To File" source="./RPA/FileSystem.py" lineno="317">
...
<kw name="Change File Extension" source="./RPA/FileSystem.py" lineno="495">
...
<kw name="Copy Directory" source="./RPA/FileSystem.py" lineno="427">
...
<kw name="Copy File" source="./RPA/FileSystem.py" lineno="395">
<arguments repr="source, destination">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Copy Files" source="./RPA/FileSystem.py" lineno="410">
...
<kw name="Create Binary File" source="./RPA/FileSystem.py" lineno="303">
...
<kw name="Create Directory" source="./RPA/FileSystem.py" lineno="342">
...
<kw name="Create File" source="./RPA/FileSystem.py" lineno="288">
...
<kw name="Does Directory Exist" source="./RPA/FileSystem.py" lineno="213">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
:param path:    path to inspected directory</doc>
<shortdoc>Returns True if the given directory exists, False if not.</shortdoc>
</kw>
<kw name="Does Directory Not Exist" source="./RPA/FileSystem.py" lineno="220">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Does File Exist" source="./RPA/FileSystem.py" lineno="199">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
:param path:    path to inspected file</doc>
<shortdoc>Returns True if the given file exists, False if not.</shortdoc>
</kw>
<kw name="Does File Not Exist" source="./RPA/FileSystem.py" lineno="206">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Empty Directory" source="./RPA/FileSystem.py" lineno="384">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Find Files" source="./RPA/FileSystem.py" lineno="125">
...
<kw name="Get File Creation Date" source="./RPA/FileSystem.py" lineno="550">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
:param path:    path to file</doc>
<shortdoc>Returns the suffix for the file.</shortdoc>
</kw>
<kw name="Get File Modified Date" source="./RPA/FileSystem.py" lineno="542">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Get File Name" source="./RPA/FileSystem.py" lineno="528">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Get File Owner" source="./RPA/FileSystem.py" lineno="567">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Get File Size" source="./RPA/FileSystem.py" lineno="559">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Is Directory Empty" source="./RPA/FileSystem.py" lineno="227">
...
<kw name="Is Directory Not Empty" source="./RPA/FileSystem.py" lineno="238">
<arguments repr="path=None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="path=None">
<name>path</name>
<default>None</default>
...
<kw name="Is File Empty" source="./RPA/FileSystem.py" lineno="245">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Is File Not Empty" source="./RPA/FileSystem.py" lineno="255">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Join Path" source="./RPA/FileSystem.py" lineno="504">
...
:param parts:  Components of the path, e.g. dir, subdir, filename.ext</doc>
<shortdoc>Joins multiple parts of a path together.</shortdoc>
</kw>
<kw name="List Directories In Directory" source="./RPA/FileSystem.py" lineno="164">
<arguments repr="path=None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="path=None">
<name>path</name>
<default>None</default>
...
:param path:    base directory for search, defaults to current working dir</doc>
<shortdoc>Lists all the directories in the given directory, relative to it.</shortdoc>
</kw>
<kw name="List Files In Directory" source="./RPA/FileSystem.py" lineno="156">
<arguments repr="path=None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="path=None">
<name>path</name>
<default>None</default>
...
<kw name="Log Directory Tree" source="./RPA/FileSystem.py" lineno="172">
<arguments repr="path=None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="path=None">
<name>path</name>
<default>None</default>
...
<kw name="Move Directory" source="./RPA/FileSystem.py" lineno="478">
...
<kw name="Move File" source="./RPA/FileSystem.py" lineno="443">
<arguments repr="source, destination, overwrite=False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Move Files" source="./RPA/FileSystem.py" lineno="462">
...
<kw name="Normalize Path" source="./RPA/FileSystem.py" lineno="520">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
:return:        path to file</doc>
<shortdoc>Removes redundant separators or up-level references from path.</shortdoc>
</kw>
<kw name="Read Binary File" source="./RPA/FileSystem.py" lineno="271">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
:param encoding:    character encoding of file</doc>
<shortdoc>Reads a file as text, with given `encoding`, and returns the content."</shortdoc>
</kw>
<kw name="Remove Directory" source="./RPA/FileSystem.py" lineno="373">
...
<kw name="Remove File" source="./RPA/FileSystem.py" lineno="351">
...
<kw name="Remove Files" source="./RPA/FileSystem.py" lineno="363">
...
<kw name="Run Keyword If File Exists" source="./RPA/FileSystem.py" lineno="633">
...
<kw name="Touch File" source="./RPA/FileSystem.py" lineno="280">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Wait Until Created" source="./RPA/FileSystem.py" lineno="598">
...
<kw name="Wait Until Modified" source="./RPA/FileSystem.py" lineno="610">
<arguments repr="path, timeout=5.0">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Wait Until Removed" source="./RPA/FileSystem.py" lineno="623">
<arguments repr="path, timeout=5.0">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
