...
<keywordspec name="RPA.JavaAccessBridge" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:50Z" specversion="3" source="./RPA/JavaAccessBridge.py" lineno="150">
<version/>
...
<inits>
<init name="Init" source="./RPA/JavaAccessBridge.py" lineno="334">
...
<keywords>
<kw name="Application Refresh" source="./RPA/JavaAccessBridge.py" lineno="824">
<arguments repr="">
</arguments>
...
<kw name="Call Element Action" source="./RPA/JavaAccessBridge.py" lineno="773">
...
<kw name="Click Coordinates" source="./RPA/JavaAccessBridge.py" lineno="798">
...
<kw name="Click Element" source="./RPA/JavaAccessBridge.py" lineno="730">
<arguments repr="locator: ContextNode | JavaElement | str, index: int = 0, action: bool = True, timeout: int = 10">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: ContextNode | JavaElement | str">
<name>locator</name>
<type>ContextNode</type>
<type>JavaElement</type>
<type>str</type>
</arg>
...
<kw name="Click Push Button" source="./RPA/JavaAccessBridge.py" lineno="869">
...
<kw name="Get Element Actions" source="./RPA/JavaAccessBridge.py" lineno="685">
...
<kw name="Get Element Text" source="./RPA/JavaAccessBridge.py" lineno="653">
...
<kw name="Get Elements" source="./RPA/JavaAccessBridge.py" lineno="565">
<arguments repr="locator: str, java_elements: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str">
<name>locator</name>
<type>str</type>
</arg>
...
.. code:: python
    ...
    for e in elements:
        print(e.name if e.name else "EMPTY", e.visible, e.x, e.y)</doc>
<shortdoc>Get matching elements</shortdoc>
</kw>
<kw name="Get Version Info" source="./RPA/JavaAccessBridge.py" lineno="883">
<arguments repr="">
</arguments>
<doc>Get Java Access Bridge version information</doc>
<shortdoc>Get Java Access Bridge version information</shortdoc>
</kw>
<kw name="Highlight Element" source="./RPA/JavaAccessBridge.py" lineno="705">
<arguments repr="locator: ContextNode | JavaElement | str, index: int = 0">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: ContextNode | JavaElement | str">
<name>locator</name>
<type>ContextNode</type>
...
<kw name="Press Keys" source="./RPA/JavaAccessBridge.py" lineno="833">
<arguments repr="*keys">
...
<kw name="Print Element Tree" source="./RPA/JavaAccessBridge.py" lineno="845">
...
<kw name="Read Table" source="./RPA/JavaAccessBridge.py" lineno="896">
<arguments repr="locator: ContextNode | JavaElement | str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: ContextNode | JavaElement | str">
<name>locator</name>
<type>ContextNode</type>
...
<kw name="Select Menu" source="./RPA/JavaAccessBridge.py" lineno="859">
...
<kw name="Select Window" source="./RPA/JavaAccessBridge.py" lineno="410">
...
<kw name="Set Display Scale Factor" source="./RPA/JavaAccessBridge.py" lineno="397">
...
<kw name="Set Mouse Position" source="./RPA/JavaAccessBridge.py" lineno="502">
...
<kw name="Shutdown Jab" source="./RPA/JavaAccessBridge.py" lineno="878">
<arguments repr="">
</arguments>
<doc>Call Java Access Bridge process shutdown</doc>
<shortdoc>Call Java Access Bridge process shutdown</shortdoc>
</kw>
<kw name="Toggle Drop Down" source="./RPA/JavaAccessBridge.py" lineno="814">
<arguments repr="locator: ContextNode | JavaElement | str, index: int = 0">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: ContextNode | JavaElement | str">
<name>locator</name>
<type>ContextNode</type>
...
<kw name="Type Text" source="./RPA/JavaAccessBridge.py" lineno="514">
...
<kw name="Wait Until Element Is Focused" source="./RPA/JavaAccessBridge.py" lineno="631">
...
<kw name="Wait Until Element Text Contains" source="./RPA/JavaAccessBridge.py" lineno="589">
...
<kw name="Wait Until Element Text Equals" source="./RPA/JavaAccessBridge.py" lineno="610">
<arguments repr="locator: ContextNode | JavaElement | str, text: str, index: int = 0, timeout: float = 0.5">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: ContextNode | JavaElement | str">
<name>locator</name>
<type>ContextNode</type>
