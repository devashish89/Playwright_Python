...
<keywordspec name="RPA.Desktop" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:47Z" specversion="3" source="./RPA/Desktop/__init__.py" lineno="37">
<version/>
...
<kw name="Close All Applications" source="./RPA/Desktop/keywords/application.py" lineno="191">
<arguments repr="">
</arguments>
...
<kw name="Close Application" source="./RPA/Desktop/keywords/application.py" lineno="173">
...
<kw name="Define Region" source="./RPA/Desktop/keywords/screen.py" lineno="187">
...
<kw name="Find Element" source="./RPA/Desktop/keywords/finder.py" lineno="284">
<arguments repr="locator: str | Locator">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str | Locator">
<name>locator</name>
<type>str</type>
...
.. code-block:: robotframework
    ...
    Log    Found logo at ${match.x}, ${match.y}</doc>
...
<kw name="Find Elements" source="./RPA/Desktop/keywords/finder.py" lineno="262">
<arguments repr="locator: str | Locator">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str | Locator">
<name>locator</name>
<type>str</type>
...
<kw name="Get Display Dimensions" source="./RPA/Desktop/keywords/screen.py" lineno="161">
<arguments repr="">
</arguments>
...
<kw name="Highlight Elements" source="./RPA/Desktop/keywords/screen.py" lineno="169">
<arguments repr="locator: str | Locator">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str | Locator">
<name>locator</name>
<type>str</type>
...
<kw name="Move Region" source="./RPA/Desktop/keywords/screen.py" lineno="210">
...
<kw name="Open Application" source="./RPA/Desktop/keywords/application.py" lineno="77">
...
<kw name="Open File" source="./RPA/Desktop/keywords/application.py" lineno="96">
...
<kw name="Resize Region" source="./RPA/Desktop/keywords/screen.py" lineno="234">
...
<kw name="Set Default Confidence" source="./RPA/Desktop/keywords/finder.py" lineno="361">
...
<kw name="Set Default Timeout" source="./RPA/Desktop/keywords/finder.py" lineno="353">
...
<kw name="Wait For Element" source="./RPA/Desktop/keywords/finder.py" lineno="314">
