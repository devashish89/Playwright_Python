...
<keywordspec name="RPA.Word.Application" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:51Z" specversion="3" source="./RPA/Word/Application.py" lineno="24">
<version/>
...
<keywords>
<kw name="Close Document" source="./RPA/Word/Application.py" lineno="91">
...
<kw name="Create New Document" source="./RPA/Word/Application.py" lineno="122">
<arguments repr="">
</arguments>
<doc>Create new document for Word application</doc>
<shortdoc>Create new document for Word application</shortdoc>
</kw>
<kw name="Export To Pdf" source="./RPA/Word/Application.py" lineno="127">
...
<kw name="Get All Texts" source="./RPA/Word/Application.py" lineno="214">
<arguments repr="">
</arguments>
...
<kw name="Open Application" source="./RPA/Word/Application.py" lineno="74">
...
<kw name="Open File" source="./RPA/Word/Application.py" lineno="103">
...
<kw name="Quit Application" source="./RPA/Word/Application.py" lineno="96">
<arguments repr="save_changes: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="save_changes: bool = False">
<name>save_changes</name>
<type>bool</type>
...
<kw name="Replace Text" source="./RPA/Word/Application.py" lineno="149">
...
<kw name="Save Document" source="./RPA/Word/Application.py" lineno="175">
<arguments repr="">
</arguments>
<doc>Save active document</doc>
<shortdoc>Save active document</shortdoc>
</kw>
<kw name="Save Document As" source="./RPA/Word/Application.py" lineno="185">
...
<kw name="Set Footer" source="./RPA/Word/Application.py" lineno="166">
...
<kw name="Set Header" source="./RPA/Word/Application.py" lineno="157">
<arguments repr="text: str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="text: str">
<name>text</name>
<type>str</type>
...
<kw name="Write Text" source="./RPA/Word/Application.py" lineno="137">
