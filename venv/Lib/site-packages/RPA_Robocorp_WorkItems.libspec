...
<keywordspec name="RPA.Robocorp.WorkItems" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:51Z" specversion="3" source="./RPA/Robocorp/WorkItems.py" lineno="710">
<version/>
...
<inits>
<init name="Init" source="./RPA/Robocorp/WorkItems.py" lineno="853">
<arguments repr="autoload: bool = True, root: str | None = None, default_adapter: Type[RPA.Robocorp.WorkItems.BaseAdapter] | str = &lt;class 'RPA.Robocorp.WorkItems.RobocorpAdapter'&gt;, auto_parse_email: Dict[str, str] | None = {'rawEmail': 'parsedEmail'}">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="default_adapter: Type[RPA.Robocorp.WorkItems.BaseAdapter] | str = &lt;class 'RPA.Robocorp.WorkItems.RobocorpAdapter'&gt;">
<name>default_adapter</name>
<type>Type[RPA.Robocorp.WorkItems.BaseAdapter]</type>
<type>str</type>
<default>&lt;class 'RPA.Robocorp.WorkItems.RobocorpAdapter'&gt;</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="auto_parse_email: Dict[str, str] | None = {'rawEmail': 'parsedEmail'}">
<name>auto_parse_email</name>
<type>Dict[str, str]</type>
<type>None</type>
<default>{'rawEmail': 'parsedEmail'}</default>
</arg>
</arguments>
...
<keywords>
<kw name="Add Work Item File" source="./RPA/Robocorp/WorkItems.py" lineno="1325">
...
<kw name="Add Work Item Files" source="./RPA/Robocorp/WorkItems.py" lineno="1393">
...
<kw name="Clear Work Item" source="./RPA/Robocorp/WorkItems.py" lineno="1107">
<arguments repr="">
</arguments>
...
<kw name="Create Output Work Item" source="./RPA/Robocorp/WorkItems.py" lineno="1061">
<arguments repr="">
</arguments>
<doc>Create a new output work item.
...
.. code-block:: robotframework
    ...
    FOR    ${customer}    IN    @{customers}
        ...
        Save work item
    END</doc>
<shortdoc>Create a new output work item.</shortdoc>
</kw>
<kw name="Delete Work Item Variables" source="./RPA/Robocorp/WorkItems.py" lineno="1253">
...
<kw name="For Each Input Work Item" source="./RPA/Robocorp/WorkItems.py" lineno="1457">
...
<kw name="Get Current Work Item" source="./RPA/Robocorp/WorkItems.py" lineno="1637">
<arguments repr="">
</arguments>
...
<kw name="Get Input Work Item" source="./RPA/Robocorp/WorkItems.py" lineno="1031">
...
<kw name="Get Work Item File" source="./RPA/Robocorp/WorkItems.py" lineno="1305">
...
<kw name="Get Work Item Files" source="./RPA/Robocorp/WorkItems.py" lineno="1364">
...
<kw name="Get Work Item Payload" source="./RPA/Robocorp/WorkItems.py" lineno="1121">
<arguments repr="">
</arguments>
...
<kw name="Get Work Item Variable" source="./RPA/Robocorp/WorkItems.py" lineno="1168">
<arguments repr="name, default=&lt;object object at 0x00000232AD756150&gt;">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="name">
<name>name</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="default=&lt;object object at 0x00000232AD756150&gt;">
<name>default</name>
<default>&lt;object object at 0x00000232AD756150&gt;</default>
</arg>
</arguments>
...
.. code-block:: robotframework
    ...
    ${username}=    Get work item variable    username    default=guest</doc>
<shortdoc>Return a single variable value from the work item, or default value if defined and key does not exist.</shortdoc>
</kw>
<kw name="Get Work Item Variables" source="./RPA/Robocorp/WorkItems.py" lineno="1193">
<arguments repr="">
</arguments>
...
.. code-block:: robotframework
    ...
    Log    Username: ${variables}[username], Email: ${variables}[email]</doc>
<shortdoc>Read all variables from the current work item and return their names and values as a dictionary.</shortdoc>
</kw>
<kw name="List Work Item Files" source="./RPA/Robocorp/WorkItems.py" lineno="1292">
<arguments repr="">
</arguments>
...
<kw name="List Work Item Variables" source="./RPA/Robocorp/WorkItems.py" lineno="1154">
<arguments repr="">
</arguments>
...
<kw name="Release Input Work Item" source="./RPA/Robocorp/WorkItems.py" lineno="1549">
<arguments repr="state: State, _auto_release: bool = False, exception_type: Error | None = None, code: str | None = None, message: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="state: State">
<name>state</name>
<type>State</type>
</arg>
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="exception_type: Error | None = None">
...
<kw name="Remove Work Item File" source="./RPA/Robocorp/WorkItems.py" lineno="1345">
...
<kw name="Remove Work Item Files" source="./RPA/Robocorp/WorkItems.py" lineno="1416">
...
<kw name="Save Work Item" source="./RPA/Robocorp/WorkItems.py" lineno="1100">
<arguments repr="">
</arguments>
...
<kw name="Set Current Work Item" source="./RPA/Robocorp/WorkItems.py" lineno="1008">
...
<kw name="Set Task Variables From Work Item" source="./RPA/Robocorp/WorkItems.py" lineno="1275">
<arguments repr="">
</arguments>
...
<shortdoc>Convert all variables in the current work item to Robot Framework task variables.</shortdoc>
</kw>
<kw name="Set Work Item Payload" source="./RPA/Robocorp/WorkItems.py" lineno="1136">
...
<kw name="Set Work Item Variable" source="./RPA/Robocorp/WorkItems.py" lineno="1217">
...
<kw name="Set Work Item Variables" source="./RPA/Robocorp/WorkItems.py" lineno="1235">
