...
<keywordspec name="RPA.Robocorp.Process" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:51Z" specversion="3" source="./RPA/Robocorp/Process.py" lineno="41">
<version/>
...
<inits>
<init name="Init" source="./RPA/Robocorp/Process.py" lineno="138">
...
<keywords>
<kw name="Create Input Work Item" source="./RPA/Robocorp/Process.py" lineno="275">
...
:param process_id: specific process to which item belongs to</doc>
...
<kw name="Get Process Id By Name" source="./RPA/Robocorp/Process.py" lineno="461">
...
:param workspace_id: specific Control Room workspace to which process belongs to</doc>
...
<kw name="Get Process Run Status" source="./RPA/Robocorp/Process.py" lineno="445">
<arguments repr="process_run_id: str, process_id: str | None = None">
...
:param process_id: specific process to which runs belongs to</doc>
...
<kw name="Get Work Item" source="./RPA/Robocorp/Process.py" lineno="374">
...
<kw name="List Process Runs" source="./RPA/Robocorp/Process.py" lineno="393">
...
<kw name="List Process Runs In Workspace" source="./RPA/Robocorp/Process.py" lineno="419">
...
<kw name="List Process Work Items" source="./RPA/Robocorp/Process.py" lineno="350">
...
:param process_id: specific process to which items belongs to</doc>
...
<kw name="List Processes" source="./RPA/Robocorp/Process.py" lineno="337">
...
<kw name="Retry Work Item" source="./RPA/Robocorp/Process.py" lineno="473">
...
:param process_id: specific process to start</doc>
...
<kw name="Set Apikey" source="./RPA/Robocorp/Process.py" lineno="184">
...
<kw name="Set Credentials" source="./RPA/Robocorp/Process.py" lineno="193">
...
<kw name="Set Process Id" source="./RPA/Robocorp/Process.py" lineno="175">
...
<kw name="Set Workspace Id" source="./RPA/Robocorp/Process.py" lineno="166">
<arguments repr="workspace_id: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="workspace_id: str | None = None">
<name>workspace_id</name>
<type>str</type>
...
<kw name="Start Configured Process" source="./RPA/Robocorp/Process.py" lineno="246">
...
<kw name="Start Process" source="./RPA/Robocorp/Process.py" lineno="223">
<arguments repr="work_items: Dict | List[typing.Dict] | None = None, batch: bool = False, process_id: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="work_items: Dict | List[typing.Dict] | None = None">
<name>work_items</name>
<type>Dict</type>
<type>List[typing.Dict]</type>
<type>None</type>
<default>None</default>
</arg>
