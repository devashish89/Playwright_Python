...
<keywordspec name="RPA.Email.Exchange" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:48Z" specversion="3" source="./RPA/Email/Exchange.py" lineno="32">
<version/>
...
<keywords>
<kw name="Authorize" source="./RPA/Email/Exchange.py" lineno="119">
...
<kw name="Create Folder" source="./RPA/Email/Exchange.py" lineno="330">
...
<kw name="Delete Folder" source="./RPA/Email/Exchange.py" lineno="350">
<arguments repr="folder_name: str | None = None, parent_folder: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="folder_name: str | None = None">
<name>folder_name</name>
<type>str</type>
...
<kw name="Empty Folder" source="./RPA/Email/Exchange.py" lineno="397">
...
<kw name="List Messages" source="./RPA/Email/Exchange.py" lineno="155">
...
<kw name="List Unread Messages" source="./RPA/Email/Exchange.py" lineno="189">
<arguments repr="folder_name: str | None = None, criterion: str | None = None, contains: bool = False, count: int = 100, save_dir: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="folder_name: str | None = None">
<name>folder_name</name>
<type>str</type>
...
<kw name="Move Message" source="./RPA/Email/Exchange.py" lineno="454">
...
<kw name="Move Messages" source="./RPA/Email/Exchange.py" lineno="419">
...
<kw name="Rename Folder" source="./RPA/Email/Exchange.py" lineno="369">
...
<kw name="Save Attachments" source="./RPA/Email/Exchange.py" lineno="612">
<arguments repr="message: dict, save_dir: str | None = None">
...
:return: list of saved attachments</doc>
<shortdoc>Save attachments in message into given directory</shortdoc>
</kw>
<kw name="Save Message" source="./RPA/Email/Exchange.py" lineno="621">
...
<kw name="Send Message" source="./RPA/Email/Exchange.py" lineno="218">
...
<kw name="Wait For Message" source="./RPA/Email/Exchange.py" lineno="515">
