...
<keywordspec name="RPA.Netsuite" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:50Z" specversion="3" source="./RPA/Netsuite.py" lineno="34">
<version/>
...
<keywords>
<kw name="Connect" source="./RPA/Netsuite.py" lineno="108">
...
<kw name="Get Accounts" source="./RPA/Netsuite.py" lineno="268">
...
<kw name="Get Classifications" source="./RPA/Netsuite.py" lineno="317">
<arguments repr="">
</arguments>
...
<kw name="Get Currencies" source="./RPA/Netsuite.py" lineno="293">
<arguments repr="">
</arguments>
...
<kw name="Get Currency" source="./RPA/Netsuite.py" lineno="284">
...
<kw name="Get Departments" source="./RPA/Netsuite.py" lineno="309">
<arguments repr="">
</arguments>
...
<kw name="Get Locations" source="./RPA/Netsuite.py" lineno="301">
<arguments repr="">
</arguments>
...
<kw name="Get Vendor Bills" source="./RPA/Netsuite.py" lineno="334">
...
<kw name="Get Vendors" source="./RPA/Netsuite.py" lineno="325">
<arguments repr="count: int = 10">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="count: int = 10">
<name>count</name>
<type>int</type>
...
<kw name="Login" source="./RPA/Netsuite.py" lineno="145">
...
<kw name="Netsuite Get" source="./RPA/Netsuite.py" lineno="182">
...
<kw name="Netsuite Get All" source="./RPA/Netsuite.py" lineno="209">
...
<kw name="Netsuite Search" source="./RPA/Netsuite.py" lineno="222">
...
<kw name="Netsuite Search All" source="./RPA/Netsuite.py" lineno="253">
