...
<keywordspec name="RPA.Email.ImapSmtp" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:49Z" specversion="3" source="./RPA/Email/ImapSmtp.py" lineno="106">
<version/>
...
<inits>
<init name="Init" source="./RPA/Email/ImapSmtp.py" lineno="192">
<arguments repr="smtp_server: str | None = None, smtp_port: int = 587, imap_server: str | None = None, imap_port: int = 993, account: str | None = None, password: str | None = None, encoding: str = utf-8">
...
<keywords>
<kw name="Add Gmail Labels" source="./RPA/Email/ImapSmtp.py" lineno="1377">
...
<kw name="Authorize" source="./RPA/Email/ImapSmtp.py" lineno="343">
<arguments repr="account: str | None = None, password: str | None = None, smtp_server: str | None = None, imap_server: str | None = None, smtp_port: int | None = None, imap_port: int | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="account: str | None = None">
<name>account</name>
<type>str</type>
<type>None</type>
...
<kw name="Authorize Imap" source="./RPA/Email/ImapSmtp.py" lineno="298">
<arguments repr="account: str | None = None, password: str | None = None, imap_server: str | None = None, imap_port: int | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="account: str | None = None">
<name>account</name>
<type>str</type>
<type>None</type>
...
<kw name="Authorize Smtp" source="./RPA/Email/ImapSmtp.py" lineno="252">
<arguments repr="account: str | None = None, password: str | None = None, smtp_server: str | None = None, smtp_port: int | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="account: str | None = None">
<name>account</name>
<type>str</type>
<type>None</type>
...
<kw name="Create Folder" source="./RPA/Email/ImapSmtp.py" lineno="1119">
...
<kw name="Delete Folder" source="./RPA/Email/ImapSmtp.py" lineno="1091">
<arguments repr="folder_name: str = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="folder_name: str = None">
<name>folder_name</name>
<type>str</type>
...
<kw name="Delete Message" source="./RPA/Email/ImapSmtp.py" lineno="724">
<arguments repr="criterion: str = ">
...
<kw name="Delete Messages" source="./RPA/Email/ImapSmtp.py" lineno="745">
<arguments repr="criterion: str = , limit: int = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="criterion: str = ">
<name>criterion</name>
<type>str</type>
<default/>
...
<kw name="Do Message Actions" source="./RPA/Email/ImapSmtp.py" lineno="1419">
<arguments repr="criterion: str = , actions: list = None, source_folder: str = None, target_folder: str = None, labels: str = None, limit: int = None, overwrite: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="criterion: str = ">
<name>criterion</name>
<type>str</type>
<default/>
...
<kw name="Email To Document" source="./RPA/Email/ImapSmtp.py" lineno="1496">
...
<kw name="Flag Messages" source="./RPA/Email/ImapSmtp.py" lineno="1147">
<arguments repr="criterion: str = None, unflag: bool = False">
...
<kw name="Get Decoded Email Body" source="./RPA/Email/ImapSmtp.py" lineno="523">
...
<kw name="Get Folder List" source="./RPA/Email/ImapSmtp.py" lineno="996">
...
<kw name="List Messages" source="./RPA/Email/ImapSmtp.py" lineno="797">
...
<kw name="Mark As Read" source="./RPA/Email/ImapSmtp.py" lineno="1185">
<arguments repr="criterion: str = None, unread: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="criterion: str = None">
<name>criterion</name>
<type>str</type>
<default>None</default>
...
<kw name="Mark As Unread" source="./RPA/Email/ImapSmtp.py" lineno="1207">
<arguments repr="criterion: str = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="criterion: str = None">
<name>criterion</name>
<type>str</type>
<default>None</default>
...
<kw name="Move Messages" source="./RPA/Email/ImapSmtp.py" lineno="1271">
<arguments repr="criterion: str = None, target_folder: str = None, source_folder: str = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="criterion: str = None">
<name>criterion</name>
<type>str</type>
<default>None</default>
...
<kw name="Move Messages By Ids" source="./RPA/Email/ImapSmtp.py" lineno="1320">
...
<kw name="Remove Gmail Labels" source="./RPA/Email/ImapSmtp.py" lineno="1398">
<arguments repr="labels, criterion, source_folder: str = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="labels">
<name>labels</name>
</arg>
...
<kw name="Rename Folder" source="./RPA/Email/ImapSmtp.py" lineno="1057">
...
<kw name="Save Attachment" source="./RPA/Email/ImapSmtp.py" lineno="875">
<arguments repr="message: dict | Message, target_folder: str, overwrite: bool">
...
<doc>Save mail attachment of single given email into local folder
...
.. code-block:: robotframework
    ...
    FOR    ${email}    IN    @{emails}
        ...
        END
    END</doc>
<shortdoc>Save mail attachment of single given email into local folder</shortdoc>
</kw>
<kw name="Save Attachments" source="./RPA/Email/ImapSmtp.py" lineno="845">
<arguments repr="criterion: str = , target_folder: str = None, overwrite: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="criterion: str = ">
<name>criterion</name>
<type>str</type>
<default/>
...
<doc>Save mail attachments of emails matching criterion into local folder.
...
.. code-block:: robotframework
    ...
    END</doc>
<shortdoc>Save mail attachments of emails matching criterion into local folder.</shortdoc>
</kw>
<kw name="Save Messages" source="./RPA/Email/ImapSmtp.py" lineno="768">
<arguments repr="criterion: str = , target_folder: str = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="criterion: str = ">
<name>criterion</name>
<type>str</type>
<default/>
...
<kw name="Select Folder" source="./RPA/Email/ImapSmtp.py" lineno="1030">
...
<kw name="Send Message" source="./RPA/Email/ImapSmtp.py" lineno="382">
<arguments repr="sender: str, recipients: str, subject: str = , body: str = , attachments: List[str] | str | None = None, html: bool = False, images: str | None = None">
...
<kw name="Send Smtp Hello" source="./RPA/Email/ImapSmtp.py" lineno="374">
<arguments repr="">
</arguments>
...
<kw name="Set Credentials" source="./RPA/Email/ImapSmtp.py" lineno="235">
...
<kw name="Unflag Messages" source="./RPA/Email/ImapSmtp.py" lineno="1170">
<arguments repr="criterion: str = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="criterion: str = None">
<name>criterion</name>
<type>str</type>
...
<kw name="Wait For Message" source="./RPA/Email/ImapSmtp.py" lineno="946">
