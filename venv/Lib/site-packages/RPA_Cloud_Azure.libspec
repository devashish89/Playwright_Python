...
<keywordspec name="RPA.Cloud.Azure" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:47Z" specversion="3" source="./RPA/Cloud/Azure.py" lineno="592">
<version/>
...
<inits>
<init name="Init" source="./RPA/Cloud/Azure.py" lineno="741">
<arguments repr="region: str = northeurope, robocloud_vault_name: str | None = None">
...
<keywords>
<kw name="Detect Face" source="./RPA/Cloud/Azure.py" lineno="295">
...
<kw name="Detect Language" source="./RPA/Cloud/Azure.py" lineno="224">
...
<kw name="Find Entities" source="./RPA/Cloud/Azure.py" lineno="257">
...
<kw name="Init Computer Vision Service" source="./RPA/Cloud/Azure.py" lineno="360">
<arguments repr="region: str | None = None, use_robocloud_vault: bool = False">
...
:param use_robocloud_vault: use secret stored into `Robocorp Vault`</doc>
<shortdoc>Initialize Azure Computer Vision</shortdoc>
</kw>
<kw name="Init Face Service" source="./RPA/Cloud/Azure.py" lineno="283">
<arguments repr="region: str | None = None, use_robocloud_vault: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="region: str | None = None">
<name>region</name>
<type>str</type>
...
<kw name="Init Speech Service" source="./RPA/Cloud/Azure.py" lineno="479">
<arguments repr="region: str | None = None, use_robocloud_vault: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="region: str | None = None">
<name>region</name>
<type>str</type>
...
<kw name="Init Text Analytics Service" source="./RPA/Cloud/Azure.py" lineno="192">
<arguments repr="region: str | None = None, use_robocloud_vault: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="region: str | None = None">
<name>region</name>
<type>str</type>
...
<kw name="Key Phrases" source="./RPA/Cloud/Azure.py" lineno="238">
...
<kw name="List Supported Voices" source="./RPA/Cloud/Azure.py" lineno="565">
...
<kw name="Sentiment Analyze" source="./RPA/Cloud/Azure.py" lineno="204">
<arguments repr="text: str, language: str | None = None, json_file: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="text: str">
<name>text</name>
<type>str</type>
...
<kw name="Set Robocloud Vault" source="./RPA/Cloud/Azure.py" lineno="174">
...
<kw name="Text To Speech" source="./RPA/Cloud/Azure.py" lineno="491">
...
<kw name="Vision Analyze" source="./RPA/Cloud/Azure.py" lineno="372">
...
<kw name="Vision Describe" source="./RPA/Cloud/Azure.py" lineno="413">
...
<kw name="Vision Detect Objects" source="./RPA/Cloud/Azure.py" lineno="449">
<arguments repr="image_file: str | None = None, image_url: str | None = None, json_file: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="image_file: str | None = None">
<name>image_file</name>
<type>str</type>
...
<kw name="Vision Ocr" source="./RPA/Cloud/Azure.py" lineno="431">
<arguments repr="image_file: str | None = None, image_url: str | None = None, json_file: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="image_file: str | None = None">
<name>image_file</name>
<type>str</type>
