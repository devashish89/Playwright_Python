...
<keywordspec name="RPA.Dialogs" type="LIBRARY" format="REST" scope="GLOBAL" generated="2022-01-12T14:02:48Z" specversion="3" source="./RPA/Dialogs/library.py" lineno="18">
<version/>
...
<keywords>
<kw name="Add checkbox" source="./RPA/Dialogs/library.py" lineno="783">
...
<kw name="Add Date Input" source="./RPA/Dialogs/library.py" lineno="683">
...
<kw name="Add drop-down" source="./RPA/Dialogs/library.py" lineno="634">
...
<kw name="Add file" source="./RPA/Dialogs/library.py" lineno="307">
...
<kw name="Add file input" source="./RPA/Dialogs/library.py" lineno="558">
...
<kw name="Add files" source="./RPA/Dialogs/library.py" lineno="348">
...
<kw name="Add heading" source="./RPA/Dialogs/library.py" lineno="167">
...
<kw name="Add hidden input" source="./RPA/Dialogs/library.py" lineno="523">
...
<kw name="Add icon" source="./RPA/Dialogs/library.py" lineno="393">
...
<kw name="Add image" source="./RPA/Dialogs/library.py" lineno="267">
...
<kw name="Add link" source="./RPA/Dialogs/library.py" lineno="235">
...
<kw name="Add password input" source="./RPA/Dialogs/library.py" lineno="484">
...
<kw name="Add radio buttons" source="./RPA/Dialogs/library.py" lineno="735">
<arguments repr="name: str, options: List[str] | str, default: str | None = None, label: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="name: str">
<name>name</name>
<type>str</type>
...
<kw name="Add submit buttons" source="./RPA/Dialogs/library.py" lineno="825">
...
<kw name="Add text" source="./RPA/Dialogs/library.py" lineno="201">
...
<kw name="Add text input" source="./RPA/Dialogs/library.py" lineno="436">
...
<kw name="Clear elements" source="./RPA/Dialogs/library.py" lineno="148">
<arguments repr="">
</arguments>
...
<kw name="Close all dialogs" source="./RPA/Dialogs/library.py" lineno="1082">
<arguments repr="">
</arguments>
...
<kw name="Close dialog" source="./RPA/Dialogs/library.py" lineno="1056">
...
<kw name="Run dialog" source="./RPA/Dialogs/library.py" lineno="873">
...
<kw name="Show dialog" source="./RPA/Dialogs/library.py" lineno="907">
...
<kw name="Wait all dialogs" source="./RPA/Dialogs/library.py" lineno="1014">
...
<kw name="Wait dialog" source="./RPA/Dialogs/library.py" lineno="985">
